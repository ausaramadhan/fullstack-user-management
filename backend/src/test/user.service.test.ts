...
const mockUser = {
  id: 1, name: 'Test', username: 'test', role: 'admin',
  created_at: mockDateString, updated_at: mockDateString
};
...
describe('UserService', () => {
  ...
  describe('deleteUser', () => {
    ...
    it('should throw error if target user not found', async () => {
        ...
        await expect(deleteUser(targetUserId, adminPassword, actorId)).rejects.toThrow('User tidak ditemukan');
    });
  });
});